...
// SPIKE THINGY
function drawArt(x, y, midColor, centerColor, spikeColor, thickness, xSize, ySize) {
    scale(xSize, ySize);
    lineWidth(thickness);
    stroke(midColor);
...
//SNOW MAN THINGY
function drawBean(x, y, topColor, midColor, lowColor, faceColor, armColor, thickness, xSize, ySize) {
    scale(xSize, ySize);
    lineWidth(thickness);
    stroke(topColor);
